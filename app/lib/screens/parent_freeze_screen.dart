          ...
          children: [
            Container(
              ...
              child: Column(children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: WiamColors.tealTintLight, borderRadius: BorderRadius.circular(999)),
                  child: Text(hasSession ? 'كوكب الألعاب مفتوح الآن' : 'كوكب الألعاب مغلق حالياً',
                      style: bodyFont(fontSize: 13, fontWeight: FontWeight.w700, color: WiamColors.tealDeepLight)),
                ),
            ...
            Material(
              ...
              child: InkWell(
                ...
                onTap: hasSession ? () => context.read<ParentAppState>().freeze(child.childId) : null,
                child: Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(24),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(24),
                    gradient: LinearGradient(colors: [WiamColors.coral, WiamColors.coralDeep], begin: Alignment.topRight, end: Alignment.bottomLeft),
                  ),
                  child: Column(children: [
                    Container(
                      width: 56,
                    ...
                    Text('تجميد فوري', style: displayFont(fontSize: 22, fontWeight: FontWeight.w800, color: Colors.white)),
                  ]),
                ),
              ),
            ),
            const SizedBox(height: 14),
            Text('سيتم قفل اللعبة على آيباد ${child.name} فوراً، حتى لو لم ينتهِ الوقت المخصص له',
                textAlign: TextAlign.center, style: bodyFont(fontSize: 13, color: WiamColors.inkMutedLight, height: 1.6)),
          ],
        ),
      ),
    );
